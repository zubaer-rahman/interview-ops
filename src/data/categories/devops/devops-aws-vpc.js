export const devops_aws_vpc = {
  ...
  "deepDive": [
    ...
    },
    {
      ...
      "text": "Security groups: stateful (return traffic auto-allowed), allow-only rules, evaluated as a whole, support allow rules only, operate at instance level (ENI). Network ACLs: stateless (return traffic must be explicitly allowed), allow and deny rules, evaluated in order (lowest number first), operate at subnet level, support allow and deny rules. Use security groups for instance-level security and NACLs for subnet-level defense in depth."
    },
    {
      "heading": "NAT Gateway and Internet Gateway",
      "text": "Internet Gateway (IGW): horizontally scaled, redundant VPC component allowing communication between VPC and internet. One IGW per VPC. NAT Gateway: managed service that enables instances in private subnets to connect to the internet (for updates) but prevents internet from connecting to them. NAT Gateway is deployed in a public subnet with an Elastic IP. Costs: per hour + data processing. NAT Instance (EC2-based) is legacy and not recommended."
    },
    {
      "heading": "VPC Peering and Transit Gateway",
      "text": "VPC Peering: direct network connection between two VPCs (same or different account/region). No transitive peering — VPC A connected to VPC B and VPC C does not mean B can reach C. Transit Gateway: hub-and-spoke topology connecting multiple VPCs and on-premises networks. Acts as a cloud router. Supports transitive routing, VPN attachments, and Direct Connect. Preferred for complex multi-VPC architectures."
    },
    {
      "heading": "VPC Endpoints and PrivateLink",
      "text": "Gateway endpoints: connect to S3 and DynamoDB without internet access — free, uses route table. Interface endpoints (AWS PrivateLink): connect to other AWS services (API Gateway, CloudWatch, SNS) via private IPs — charged per hour + data. Endpoints keep traffic within AWS network, never traversing the internet. Best for compliance and security-sensitive workloads requiring private connectivity."
    }
  ],
  ...
  "interviewQuestions": [
    {
      ...
      "answer": "Virtual Private Cloud — a logically isolated section of AWS where you define your virtual network."
    },
    {
      "question": "What is the difference between public and private subnets?",
      "answer": "Public subnets have route to IGW (internet accessible). Private subnets have no direct internet access."
    },
    {
  ...
  "mcqQuestions": [
    {
      ...
      "options": [
        "Allow public internet to access private instances",
        "Allow private instances to access the internet",
        "Connect VPCs together",
        "Filter traffic at instance level"
      ],
      "answer": 1,
      "explanation": "NAT Gateway allows private subnet instances to initiate outbound internet access."
    },
    {
      "question": "How is a security group different from a NACL?",
      "options": [
        "Security group is stateless, NACL is stateful",
        "Security group is stateful, NACL is stateless",
        "Both are stateful",
        "Both are stateless"
      ],
      "answer": 1,
      "explanation": "Security groups are stateful (return traffic auto-allowed). NACLs are stateless (return traffic must be explicitly allowed)."
    },
    {
      ...
      "answer": 1,
      "explanation": "VPC Flow Logs capture metadata about IP traffic going through network interfaces."
    },
    {
      "question": "What is a VPC endpoint?",
      "options": [
        ...
        "Internet connection for VPC",
        "NAT Gateway alternative"
      ],
      "answer": 1,
      "explanation": "VPC endpoints provide private connectivity to AWS services without internet traversal."
    },
    {
      "question": "What is the difference between Transit Gateway and VPC Peering?",
      "options": [
        "Same thing",
        "Transit Gateway supports transitive routing, VPC Peering does not",
        "VPC Peering is more expensive",
        "Transit Gateway is only for on-premises"
      ],
      "answer": 1,
      "explanation": "Transit Gateway acts as a hub with transitive routing. VPC Peering is point-to-point without transitivity."
    },
    {
      "question": "What does CIDR 10.0.0.0/16 represent?",
      "options": [
        "256 IP addresses",
        "65,536 IP addresses",
        "16 IP addresses",
      ...
      "answer": 1,
      "explanation": "/16 provides 2^(32-16) = 65,536 IP addresses."
    },
    {
      "question": "AWS VPC — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "AWS VPC — What improves speed?",
      "options": [
    ...
    {
      "question": "AWS VPC — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "AWS VPC — What ensures quality?",
      "options": [
