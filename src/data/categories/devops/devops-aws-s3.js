export const devops_aws_s3 = {
  ...
  "laymanDefinition": "S3 is like a massive, infinitely expandable digital warehouse where you can store anything from a single photo to petabytes of data. Each item (object) is stored in a bin (bucket) with a label (key). The warehouse never floods, never catches fire (99.9999999999% durability), and you can retrieve items instantly (Standard) or wait a bit for discounted storage (Glacier). It is like having a warehouse with a money-back guarantee on every item.",
  "deepDive": [
    {
  ...
  "interviewQuestions": [
    {
      ...
      "answer": "Simple Storage Service — highly durable, scalable object storage for any type of data."
    },
    {
      "question": "What is S3\\'s durability?",
      "answer": "99.9999999999% (11 nines) — objects are replicated across multiple facilities."
    },
    {
      "question": "What are the S3 storage classes?",
      "answer": "Standard, Intelligent-Tiering, Standard-IA, One Zone-IA, Glacier, Glacier Deep Archive."
    },
    {
      "question": "What is the difference between S3 Standard and Glacier?",
      "answer": "Standard: immediate access, higher cost. Glacier: archive storage, minutes to hours retrieval, much lower cost."
    },
    {
      "question": "What is S3 versioning?",
      "answer": "Keeping multiple versions of objects to protect against accidental deletes and overwrites."
    },
    {
      "question": "What is an S3 lifecycle policy?",
      "answer": "Rules that automatically transition objects between storage classes and expire them after specified time."
    },
    {
      "question": "What is the S3 consistency model?",
      "answer": "Strong read-after-write consistency for all operations — you always read the latest version."
    },
    {
      "question": "What encryption options does S3 offer?",
      "answer": "SSE-S3 (AES-256), SSE-KMS (KMS keys), SSE-C (customer keys), and client-side encryption."
    },
    {
      "question": "What is S3 Object Lock?",
      "answer": "A feature that prevents objects from being deleted or overwritten for a fixed time or indefinitely (WORM)."
    },
    {
      "question": "What is S3 Transfer Acceleration?",
      "answer": "Fast uploads using AWS edge locations — good for long-distance or跨国 transfers."
    }
  ],
  ...
  "codeExamples": [
    {
      "title": "S3 Bucket Creation with Encryption",
      "useCase": "Create a secure bucket.",
      "code": "# Create bucket with default encryption\naws s3api create-bucket \\\n  --bucket my-secure-bucket-123 \\\n  --region us-east-1\n\n# Enable versioning\naws s3api put-bucket-versioning \\\n  --bucket my-secure-bucket-123 \\\n  --versioning-configuration Status=Enabled\n\n# Enable default encryption (SSE-S3)\naws s3api put-bucket-encryption \\\n  --bucket my-secure-bucket-123 \\\n  --server-side-encryption-configuration\n  \"{\"Rules\":[{\"ApplyServerSideEncryptionByDefault\":{\"SSEAlgorithm\":\"AES256\"}}]}\"\n\n# Block all public access\naws s3api put-public-access-block \\\n  --bucket my-secure-bucket-123 \\\n  --public-access-block-configuration\n  \"BlockPublicAcls=true,IgnorePublicAcls=true,BlockPublicPolicy=true,RestrictPublicBuckets=true\"",
      "description": "Creating a secure S3 bucket with versioning, encryption, and public access blocked."
    },
    {
      "title": "Lifecycle Policy for Cost Optimization",
      "useCase": "Automate storage tier transitions.",
      "code": "# Lifecycle policy JSON\naws s3api put-bucket-lifecycle-configuration \\\n  --bucket my-bucket \\\n  --lifecycle-configuration '{\n    \"Rules\": [{\n      \"Id\": \"ArchiveOldData\",\n      \"Status\": \"Enabled\",\n      \"Prefix\": \"logs/\",\n      \"Transitions\": [\n        {\"Days\": 30, \"StorageClass\": \"STANDARD_IA\"},\n        {\"Days\": 90, \"StorageClass\": \"GLACIER\"},\n        {\"Days\": 365, \"StorageClass\": \"DEEP_ARCHIVE\"}\n      ],\n      \"Expiration\": {\"Days\": 730}\n    }]\n  }'",
      "description": "Lifecycle policy that transitions objects from Standard to IA to Glacier to Deep Archive and expires after 2 years."
    },
    {
      "title": "S3 Static Website Hosting",
      "useCase": "Host a static site on S3.",
      ...
      "description": "Setting up S3 static website hosting with sync command and CloudFront CDN."
    },
    {
      "title": "S3 Select for Server-Side Filtering",
      "useCase": "Reduce data transfer.",
      "code": "# Query a CSV file in S3 without downloading it\naws s3api select-object-content \\\n  --bucket my-data-bucket \\\n  --key sales-2024.csv \\\n  --expression \"SELECT SUM(amount) FROM s3object WHERE region = 'US'\" \\\n  --expression-type SQL \\\n  --input-serialization '{\"CSV\": {\"FileHeaderInfo\": \"USE\"}}' \\\n  --output-serialization '{\"CSV\": {}}' \\\n  result.csv\n\n# Use S3 Select with AWS SDK\n# const params = {\n#   Bucket: 'my-data-bucket',\n#   Key: \"sales-2024.csv\",\n#   Expression: \"SELECT * FROM s3object s WHERE s.amount > 1000\",\n#   ExpressionType: \"SQL\",\n#   InputSerialization: { CSV: { FileHeaderInfo: \"USE\" } },\n#   OutputSerialization: { CSV: {} }\n# };",
      "description": "S3 Select queries data server-side, returning only matching rows to reduce data transfer costs."
    },
    {
      "title": "Cross-Region Replication",
      "useCase": "Replicate buckets across regions.",
      "code": "# Enable CRR between two buckets\n# Source bucket: my-bucket-us (us-east-1)\n# Destination bucket: my-bucket-eu (eu-west-1)\n\n# Step 1: Create IAM role for S3 replication\naws iam create-role \\\n  --role-name s3-crr-role \\\n  --assume-role-policy-document file://trust-policy.json\n\n# Step 2: Add replication configuration\naws s3api put-bucket-replication \\\n  --bucket my-bucket-us \\\n  --replication-configuration '{\n    \"Role\": \"arn:aws:iam::123456:role/s3-crr-role\",\n    \"Rules\": [{\n      \"Status\": \"Enabled\",\n      \"Priority\": 1,\n      \"Filter\": {\"Prefix\": \"\"},\n      \"Destination\": {\n        \"Bucket\": \"arn:aws:s3:::my-bucket-eu\",\n        \"StorageClass\": \"STANDARD_IA\"\n      }\n    }]\n  }'",
      "description": "Cross-region replication setup for S3 buckets with IAM role and destination storage class configuration."
    }
  ],
  "mcqQuestions": [
    {
      "question": "What is S3 durability?",
      "options": [
        "99.99%",
        "99.9999999999%",
        "99.9999%",
      ...
      "answer": 1,
      "explanation": "S3 offers 99.9999999999% (11 nines) durability across multiple facilities."
    },
    {
      "question": "Which S3 storage class is best for archival data accessed once a year?",
      "options": [
        "Standard",
        "Intelligent-Tiering",
      ...
      "answer": 2,
      "explanation": "Glacier Deep Archive is the lowest-cost storage class, designed for long-term archival."
    },
    {
      "question": "What is the S3 consistency model after Dec 2020?",
      "options": [
      ...
      "answer": 1,
      "explanation": "S3 now provides strong consistency for all operations since December 2020."
    },
    {
      "question": "What does SSE-KMS provide beyond SSE-S3?",
      "options": [
        "Better performance",
        "Separate key management and audit trail",
        "Lower cost",
        "Automatic replication"
      ],
      "answer": 1,
      "explanation": "SSE-KMS uses AWS KMS for separate key management, audit logging, and granular permissions."
    },
    {
      "question": "What is the purpose of S3 Object Lock?",
      "options": [
        "Improve performance",
        "Prevent object deletion/modification (WORM)",
        "Reduce storage costs",
        "Enable versioning"
      ],
      "answer": 1,
      "explanation": "Object Lock provides WORM protection for compliance and legal hold requirements."
    },
    {
      "question": "What is the difference between S3 bucket policy and IAM policy?",
      "options": [
        "They are the same",
        "Bucket policy is resource-based, IAM policy is identity-based",
        "Bucket policy is for users only",
        "IAM policy is for buckets only"
      ],
      "answer": 1,
      "explanation": "Bucket policies are attached to resources, IAM policies are attached to users/roles."
    },
    {
      "question": "AWS S3 — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "AWS S3 — What improves speed?",
      "options": [
    ...
    {
      "question": "AWS S3 — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "AWS S3 — What ensures quality?",
      "options": [
