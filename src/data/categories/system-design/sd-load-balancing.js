export const sd_load_balancing = {
  ...
  "codeExamples": [
    {
      ...
      "description": "Nginx L7 HTTP load balancer with least_conn and health checks."
    },
    {
      "title": "HAProxy L4 Load Balancer",
      "useCase": "TCP load balancing.",
  ...
  "mcqQuestions": [
    {
      ...
      "answer": 1,
      "explanation": "L4 operates at TCP/UDP transport layer."
    },
    {
      "question": "Which algorithm has session stickiness?",
      "options": [
        "Round Robin",
        "Least Connections",
        "IP Hash",
      ...
      "answer": 2,
      "explanation": "IP Hash maps client IP to same server."
    },
    {
      "question": "What does a health check do?",
      "options": [
        "Balance traffic",
      ...
      "answer": 1,
      "explanation": "Verifies server is healthy before sending traffic."
    },
    {
      "question": "Purpose of draining?",
      "options": [
        "Speed up",
        "Let requests finish before removal",
        "Reset connections",
        "Cache warmup"
      ],
      "answer": 1,
      "explanation": "Allow existing requests to complete."
    },
    {
      "question": "Why stateless over sticky sessions?",
      "options": [
        "More secure",
      ...
      "answer": 1,
      "explanation": "Even load distribution, survive server failure."
    },
    {
      "question": "What is proxy_next_upstream?",
      "options": [
        "Nginx retry on failure",
        "HAProxy config",
        "Round robin variant",
        "Caching directive"
      ],
      "answer": 0,
      "explanation": "Nginx retries failed request on next upstream."
    },
    {
      "question": "Load Balancing — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "Load Balancing — What improves speed?",
      "options": [
    ...
    {
      "question": "Load Balancing — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "Load Balancing — What ensures quality?",
      "options": [
