  ...
  "codeExamples": [
    {
      ...
      "description": "WebSocket chat server with presence and push notification fallback."
    },
    {
      "title": "Message Storage (Cassandra Schema)",
      "useCase": "Write-optimized messages.",
      "code": "CREATE TABLE messages_by_chat (\n  chat_id TEXT,\n  message_id TIMEUUID,\n  sender_id TEXT,\n  content TEXT,\n  message_type TEXT,\n  created_at TIMESTAMP,\n  metadata MAP<TEXT, TEXT>,\n  PRIMARY KEY (chat_id, message_id)\n) WITH CLUSTERING ORDER BY (message_id DESC)\n  AND default_time_to_live = 0;\n-- For user inbox (fan-out on write):\nCREATE TABLE user_inbox (\n  user_id TEXT,\n  message_id TIMEUUID,\n  from_user TEXT,\n  chat_id TEXT,\n  content TEXT,\n  is_read BOOLEAN,\n  PRIMARY KEY (user_id, message_id)\n) WITH CLUSTERING ORDER BY (message_id DESC);",
      "description": "Cassandra schema for chat messages and user inbox."
    },
    {
      "title": "Redis Presence Service",
      "useCase": "Online/offline tracking.",
  ...
  "mcqQuestions": [
    {
      ...
      "answer": 1,
      "explanation": "Persistent, bidirectional, full-duplex real-time communication."
    },
    {
      "question": "Fan-out on write best for?",
      "options": [
        "Large groups",
        "Small groups",
        "1-on-1",
      ...
      "answer": 1,
      "explanation": "Small groups — single write per recipient."
    },
    {
      "question": "Cassandra partition key for messages?",
      "options": [
        "Timestamp",
        "chat_id",
        "user_id",
      ...
      "answer": 1,
      "explanation": "Partition by chat_id for efficient retrieval."
    },
    {
      "question": "How is presence tracked?",
      "options": [
        "DB query",
        "Redis with TTL + heartbeat",
        "WebSocket only",
        "Polling"
      ],
      "answer": 1,
      "explanation": "Redis TTL-based presence with heartbeats."
    },
    {
      "question": "What does push notification do?",
      "options": [
        "Open WebSocket",
        "Alert when offline",
        "Sync messages",
      ...
      "answer": 1,
      "explanation": "Notifies offline users of new messages."
    },
    {
      "question": "Delivery receipt requires?",
      "options": [
        "Server ACK",
        "Client ACK on delivery",
        "Auto-ACK",
        "No ACK needed"
      ],
      "answer": 1,
      "explanation": "Client sends ACK after receiving message."
    },
    {
      "question": "Design Chat System — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "Design Chat System — What improves speed?",
      "options": [
    ...
    {
      "question": "Design Chat System — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "Design Chat System — What ensures quality?",
      "options": [
