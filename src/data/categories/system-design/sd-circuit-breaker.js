export const sd_circuit_breaker = {
  ...
  "codeExamples": [
    ...
    },
    {
      ...
      "description": "Spring Cloud Circuit Breaker (Resilience4j) with configuration."
    },
    {
      "title": "Manual Circuit Breaker Implementation",
      "useCase": "Simple version.",
      "code": "class SimpleCircuitBreaker {\n  constructor(failureThreshold = 5, resetTimeout = 30000) {\n    this.state = \"CLOSED\";\n    this.failureCount = 0;\n    this.failureThreshold = failureThreshold;\n    this.resetTimeout = resetTimeout;\n    this.lastFailureTime = null;\n  }\n  async call(fn, fallback) {\n    if (this.state === \"OPEN\") {\n      if (Date.now() - this.lastFailureTime >= this.resetTimeout) {\n        this.state = \"HALF_OPEN\";\n      } else {\n        return fallback();\n      }\n    }\n    try {\n      const result = await fn();\n      if (this.state === \"HALF_OPEN\") {\n        this.state = \"CLOSED\";\n        this.failureCount = 0;\n      }\n      return result;\n    } catch (err) {\n      this.failureCount+;\n      this.lastFailureTime = Date.now();\n      if (this.failureCount >= this.failureThreshold) {\n        this.state = \"OPEN\";\n      }\n      return fallback(err);\n    }\n  }\n}",
      "description": "Simple circuit breaker implementation illustrating the state machine."
    }
  ],
  "mcqQuestions": [
    {
    ...
    },
    {
      ...
      "answer": 1,
      "explanation": "OPEN: calls fail fast without reaching service."
    },
    {
      "question": "HALF-OPEN allows?",
      "options": [
        "All calls",
        "No calls",
        "Limited test calls",
      ...
      "answer": 2,
      "explanation": "HALF-OPEN: limited test calls to check recovery."
    },
    {
      "question": "What triggers CLOSED → OPEN?",
      "options": [
        "Success threshold",
      ...
      "answer": 1,
      "explanation": "Failure count or rate exceeds threshold."
    },
    {
      "question": "Bulkhead pattern isolates?",
      "options": [
        "Network",
      ...
      "answer": 1,
      "explanation": "Separate resource pools per downstream service."
    },
    {
      "question": "What is a fallback?",
      "options": [
        "Primary response",
        "Alternative response on failure",
        "Error log",
        "Retry queue"
      ],
      "answer": 1,
      "explanation": "Fallback provides degraded response when service is down."
    },
    {
      "question": "Circuit Breaker Pattern — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "Circuit Breaker Pattern — What improves speed?",
      "options": [
    ...
    {
      "question": "Circuit Breaker Pattern — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "Circuit Breaker Pattern — What ensures quality?",
      "options": [
