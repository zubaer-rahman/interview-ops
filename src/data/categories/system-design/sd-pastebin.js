export const sd_pastebin = {
  ...
  "codeExamples": [
    ...
    },
    {
      ...
      "description": "Rate limiting paste creation per IP to prevent abuse."
    }
  ],
  "mcqQuestions": [
    {
      ...
      "answer": 1,
      "explanation": "S3/GCS for cheap, scalable object storage."
    },
    {
      "question": "Burn-after-read means?",
      "options": [
      ...
      "answer": 1,
      "explanation": "Content deleted after being viewed once."
    },
    {
      "question": "Average paste size estimate?",
      "options": [
        "1KB",
        "10KB",
        "100KB",
      ...
      "answer": 1,
      "explanation": "~10KB average paste size."
    },
    {
      "question": "Storage for 10M pastes/day?",
      "options": [
        "1GB/day",
        "100GB/day",
        "1TB/day",
      ...
      "answer": 1,
      "explanation": "10M × 10KB = 100GB/day (compressed ~30GB)."
    },
    {
      "question": "How to handle expiry?",
      "options": [
        "TTL in DB + background cleanup",
        "Manual deletion",
        "No expiry",
        "Cache TTL only"
      ],
      "answer": 0,
      "explanation": "DB TTL + background job for cleanup."
    },
    {
      "question": "What mitigates abuse?",
      "options": [
        "No limits",
        "Rate limiting + CAPTCHA + size limits",
        "Encryption",
        "CDN"
      ],
      "answer": 1,
      "explanation": "Rate limiting, CAPTCHA, and size limits."
    },
    {
      "question": "Design Pastebin — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "Design Pastebin — What improves speed?",
      "options": [
    ...
    {
      "question": "Design Pastebin — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "Design Pastebin — What ensures quality?",
      "options": [
