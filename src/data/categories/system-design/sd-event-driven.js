  ...
  "mcqQuestions": [
    {
      ...
      "answer": 1,
      "explanation": "Loose coupling via asynchronous events."
    },
    {
      "question": "Event sourcing stores?",
      "options": [
        "Current state only",
        "All state changes as event log",
        "Only errors",
        "Aggregated data"
      ],
      "answer": 1,
      "explanation": "Append-only log of all state changes."
    },
    {
      ...
      "answer": 1,
      "explanation": "Separate read (query) and write (command) models."
    },
    {
      "question": "Kafka is commonly used as?",
      "options": [
        "Database",
        "Event bus/broker",
        "Load balancer",
      ...
      "answer": 1,
      "explanation": "Event bus/broker for event-driven architectures."
    },
    {
      "question": "Main challenge in EDA?",
      "options": [
        "Performance",
      ...
      "answer": 1,
      "explanation": "Eventual consistency — data may be stale for a period."
    },
    {
      "question": "Idempotent consumer prevents?",
      "options": [
        "Slow processing",
      ...
      "answer": 1,
      "explanation": "Idempotency prevents duplicate event processing issues."
    },
    {
      "question": "Event-Driven Architecture — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "Event-Driven Architecture — What improves speed?",
      "options": [
    ...
    {
      "question": "Event-Driven Architecture — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "Event-Driven Architecture — What ensures quality?",
      "options": [
