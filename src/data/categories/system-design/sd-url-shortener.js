  ...
  "codeExamples": [
    {
      ...
      "description": "URL shortener API — create and redirect with caching."
    },
    {
      "title": "Base62 Encoding",
      "useCase": "Encode numbers to short strings.",
      ...
      "description": "Base62 encoding/decoding for short URL codes."
    },
    {
      "title": "KGS (Key Generation Service)",
      "useCase": "Pre-generate keys.",
  ...
  "mcqQuestions": [
    {
      ...
      "answer": 2,
      "explanation": "a-z, A-Z, 0-9 = 62 characters."
    },
    {
      "question": "301 redirect is?",
      "options": [
        "Temporary redirect",
        "Permanent, cached by browser",
        "Not cached",
        "Error"
      ],
      "answer": 1,
      "explanation": "301 Moved Permanently — browser caches it."
    },
    {
      "question": "What is KGS?",
      "options": [
      ...
      "answer": 0,
      "explanation": "Pre-generates keys for fast allocation."
    },
    {
      "question": "Read/write ratio for URL shortener?",
      "options": [
        "1:1",
        "10:1",
        "100:1",
      ...
      "answer": 2,
      "explanation": "~100:1 (1B reads vs 10M writes/day)."
    },
    {
      "question": "Short URL 7 chars max?",
      "options": [
        "62^7 combinations",
        "62^6",
        "10^7",
      ...
      "answer": 0,
      "explanation": "62^7 = 3.5 trillion combinations."
    },
    {
      "question": "What cache strategy?",
      "options": [
        "Write-through + LRU",
        "Read-only",
        "No cache",
      ...
      "answer": 0,
      "explanation": "Cache-aside with LRU eviction and TTL."
    },
    {
      "question": "Design URL Shortener — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "Design URL Shortener — What improves speed?",
      "options": [
    ...
    {
      "question": "Design URL Shortener — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "Design URL Shortener — What ensures quality?",
      "options": [
