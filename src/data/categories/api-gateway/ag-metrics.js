export const ag_metrics = {
  ...
  "laymanDefinition": "API Gateway metrics are like car dashboard gauges. Speed (RPS), RPM (latency), fuel (connections), check engine light (errors). Dashboard lets you drive faster without overheating.",
  "deepDive": [
    {
      "heading": "Four Golden Signals",
      "text": "Latency: time to serve request (P50/P95/P99). Traffic: requests per second (RPS). Errors: rate of failed requests (5xx,4xx). Saturation: how \"full\" gateway is (connections, CPU)."
    },
    {
      "heading": "RED Method",
      "text": "Rate: requests per second. Errors: failed requests per second. Duration: distribution of response time. Simplifies monitoring: three metrics capture health."
    },
    {
      "heading": "Prometheus Metrics Types",
      "text": "Counter: cumulative count (total requests, errors). Gauge: current value (active connections). Histogram: bucketed latency (p50, p95, p99). Summary: quantiles."
    },
    {
      "heading": "Upstream Metrics",
      "text": "Track each backend service separately. Key: upstream_rps, upstream_latency, upstream_errors. Identify which service is slow. Circuit breaker data."
    },
    {
      "heading": "Alerting Thresholds",
      "text": "P99 latency > 500ms. Error rate > 1% (5xx). RPS drop > 50%. Active connections > 80% of max. Cache hit rate < 50%. Rate limit threshold breached."
    }
  ],
  "interviewAnswer": "Monitor four golden signals: Latency, Traffic, Errors, Saturation (USE) or Rate, Errors, Duration (RED). Use Prometheus histograms for latency. Alert on p99>500ms, error rate>1%. Upstream metrics for service-level visibility.",
  "interviewQuestions": [
    {
      "question": "Four golden signals?",
      "answer": "Latency, Traffic, Errors, Saturation."
    },
    {
      "question": "RED method components?",
      "answer": "Rate (requests/sec), Errors (failed/sec), Duration (latency)."
    },
    {
      "question": "P50 vs P99?",
      "answer": "P50: median latency. P99: 99th percentile (worst 1%)."
    },
    {
      "question": "Prometheus metric types?",
      "answer": "Counter (cumulative), Gauge (current value), Histogram (bucketed), Summary (quantiles)."
    },
    {
      "question": "What is RPS?",
      "answer": "Requests per second � measure of traffic."
    },
    {
      "question": "What to alert based on?",
      "answer": "P99 latency, error rate, connection saturation, RPS anomalies."
    },
    {
      "question": "Why track upstream metrics?",
      "answer": "Identify slow/malfunctioning backend services."
    },
    {
      "question": "Grafana vs Prometheus?",
      "answer": "Prometheus: metrics storage. Grafana: dashboard visualization."
    },
    {
      "question": "Metrics endpoint?",
      "answer": "/metrics � Prometheus scrapes this. Usually port 9090."
    },
    {
      "question": "What is saturation?",
      "answer": "How \"full\" gateway is: connections, memory, CPU."
    }
  ],
  "diagramSvg": "<svg viewBox=\"0 0 500 300\" xmlns=\"http://www.w3.org/2000/svg\" style=\"max-width:100%;height:auto;font-family:sans-serif\"><defs><marker id=\"arrow\" viewBox=\"0 0 10 10\" refX=\"9\" refY=\"5\" markerWidth=\"8\" markerHeight=\"8\" orient=\"auto\"><path d=\"M0,0 L10,5 L0,10\" fill=\"#666\" opacity=\"0.7\"/></marker></defs><rect x=\"0\" y=\"0\" width=\"500\" height=\"300\" rx=\"10\" fill=\"#f8f9fa\" stroke=\"#dee2e6\" stroke-width=\"1\"/><text x=\"250\" y=\"28\" text-anchor=\"middle\" font-size=\"14\" font-weight=\"bold\" fill=\"#333\">Metrics</text><rect x=\"10\" y=\"35\" width=\"100\" height=\"25\" rx=\"5\" fill=\"#0070f3\" stroke=\"#0070f3\" stroke-width=\"1.5\"/><text x=\"60\" y=\"51\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Gateway</text><text x=\"60\" y=\"54\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">App metrics</text><line x1=\"110\" y1=\"48\" x2=\"140\" y2=\"48\" stroke=\"#666\" stroke-width=\"1.5\" marker-end=\"url(#arrow)\"/><rect x=\"150\" y=\"35\" width=\"100\" height=\"25\" rx=\"5\" fill=\"#28a745\" stroke=\"#28a745\" stroke-width=\"1.5\"/><text x=\"200\" y=\"51\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Prometheus</text><text x=\"200\" y=\"54\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">Scrape</text><line x1=\"150\" y1=\"60\" x2=\"150\" y2=\"80\" stroke=\"#666\" stroke-width=\"1.5\" marker-end=\"url(#arrow)\"/><line x1=\"250\" y1=\"48\" x2=\"280\" y2=\"48\" stroke=\"#666\" stroke-width=\"1.5\" marker-end=\"url(#arrow)\"/><rect x=\"10\" y=\"70\" width=\"100\" height=\"25\" rx=\"5\" fill=\"#ffc107\" stroke=\"#ffc107\" stroke-width=\"1.5\"/><text x=\"60\" y=\"86\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Counters</text><text x=\"60\" y=\"89\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">Totals</text><rect x=\"10\" y=\"105\" width=\"100\" height=\"25\" rx=\"5\" fill=\"#dc3545\" stroke=\"#dc3545\" stroke-width=\"1.5\"/><text x=\"60\" y=\"121\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Histograms</text><text x=\"60\" y=\"124\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">Latencies</text><rect x=\"10\" y=\"140\" width=\"100\" height=\"25\" rx=\"5\" fill=\"#e83e8c\" stroke=\"#e83e8c\" stroke-width=\"1.5\"/><text x=\"60\" y=\"156\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Gauges</text><text x=\"60\" y=\"159\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">Cur. state</text><rect x=\"160\" y=\"70\" width=\"100\" height=\"25\" rx=\"5\" fill=\"#6610f2\" stroke=\"#6610f2\" stroke-width=\"1.5\"/><text x=\"210\" y=\"86\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Grafana</text><text x=\"210\" y=\"89\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">Dashboard</text><rect x=\"160\" y=\"105\" width=\"100\" height=\"25\" rx=\"5\" fill=\"#17a2b8\" stroke=\"#17a2b8\" stroke-width=\"1.5\"/><text x=\"210\" y=\"121\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Alerts</text><text x=\"210\" y=\"124\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">Thresholds</text><rect x=\"290\" y=\"35\" width=\"190\" height=\"155\" rx=\"5\" fill=\"#17a2b8\" stroke=\"#17a2b8\" stroke-width=\"1.5\"/><text x=\"385\" y=\"51\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Metrics</text><text x=\"385\" y=\"162\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">Four golden signals: Latency, Traf</text><text x=\"385\" y=\"173\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">fic, Errors, Saturation. Prometheu</text><text x=\"385\" y=\"184\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">s+Grafana. P50/P95/P99.</text></svg>",
  "codeExamples": "<text x=\"240\" y=\"220\" font-size=\"9\" fill=\"#666\" text-anchor=\"middle\">Metrics: Four golden signals (Latency, Traffic, Er</text><text x=\"240\" y=\"232\" font-size=\"9\" fill=\"#666\" text-anchor=\"middle\">rors, Saturation). Prometheus + Grafana. P50/P95/P</text><text x=\"240\" y=\"244\" font-size=\"9\" fill=\"#666\" text-anchor=\"middle\">99 latency. Alert on p99>500ms.</text>",
  "mcqQuestions": [
    {
      "title": "Prometheus Metrics Middleware",
      "useCase": "Expose /metrics.",
    ...
    {
      "question": "Metrics — What helps team collaboration?",
      "options": [
    ...
    {
      "question": "Metrics — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "Metrics — What improves speed?",
      "options": [
    ...
    {
      "question": "Metrics — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "Metrics — What ensures quality?",
      "options": [
