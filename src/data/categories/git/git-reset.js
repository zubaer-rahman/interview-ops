export const git_reset = {
  ...
  "laymanDefinition": "Git reset is like adjusting a VCR tape to a specific timestamp. --soft is like moving the tape position (HEAD) but leaving the picture (working dir) and loading tray (staging) untouched. --mixed also ejects the tape (unstages). --hard rewinds ejects and forgets everything after that point like it never happened.",
  "deepDive": [
    {
      "heading": "Reset Modes",
      "text": "--soft: HEAD now points to target commit. Staging area and working directory are unchanged. All changes from reset point to current state become staged. --mixed (default): HEAD moves staging area matches HEAD working directory unchanged. Changes become unstaged. --hard: HEAD moves staging and working directory match HEAD. Uncommitted changes are lost."
    },
    {
      "heading": "Reset vs Checkout",
    ...
    {
      "heading": "Soft Reset Use Cases",
      "text": "Combine multiple commits into one: git reset --soft HEAD~3 then git commit -m \"Squashed feature\". Uncommit but keep changes staged: git reset --soft HEAD~1. Adjust commit base: reset --soft to a different commit. Safe because working directory is untouched no data loss."
    },
    {
      "heading": "Mixed Reset (Default) Use Cases",
      "text": "Unstage files: git reset (defaults to --mixed HEAD). Uncommit and unstage: git reset --mixed HEAD~1. Unstage selective: git reset HEAD -- filename. Most common reset for everyday use changes remain in working directory."
    },
    {
      "heading": "Hard Reset and Recovery",
      "text": "git reset --hard HEAD~3: discards last 3 commits and all uncommitted changes. DANGEROUS. Recovery: git reflog to find the old HEAD SHA. git reset --hard <sha> to restore. Or git checkout -b recovered <sha> to create a branch. Reflog keeps history for ~90 days (git gc prunes it)."
    }
  ],
  "interviewAnswer": "Reset is powerful but dangerous. Use --soft to merge commits. Use --mixed (default) to unstage. Use --hard sparingly. Never reset shared branches. Recovery is possible via reflog but not guaranteed. For undoing shared history use revert. For local changes reset is the right tool.",
  "interviewQuestions": [
    {
      "question": "What is git reset?",
      "answer": "Moves the current branch pointer to a specified commit optionally modifying staging and working directory."
    },
    {
      "question": "What are the three reset modes?",
      "answer": "--soft (HEAD only) --mixed (HEAD + staging default) --hard (HEAD + staging + working directory)."
    },
    {
      "question": "What does --soft do?",
      "answer": "Moves HEAD only. Staging and working directory unchanged. Changes become staged."
    },
    {
      "question": "What does --mixed do?",
      "answer": "Moves HEAD and resets staging area. Working directory unchanged. Changes become unstaged. Default mode."
    },
    {
      "question": "What does --hard do?",
      "answer": "Moves HEAD resets staging area and overwrites working directory. Uncommitted changes lost."
    },
    {
      "question": "What is the default reset mode?",
      "answer": "--mixed (if no mode specified)."
    },
    {
      "question": "Can you recover from git reset --hard?",
      "answer": "Yes via git reflog. Find the old HEAD SHA and reset to it."
    },
    {
      "question": "Why should you never reset shared branches?",
      "answer": "Reset rewrites history causing divergence for other developers who have the old history."
    },
    {
      "question": "What is git reset HEAD -- filename?",
      "answer": "Unstages the file (removes from staging area) but keeps working directory changes."
    },
    {
      "question": "How do you uncommit the last commit but keep changes?",
      "answer": "git reset --soft HEAD~1 (keeps changes staged) or git reset HEAD~1 (keeps changes unstaged)."
    }
  ],
  "diagramSvg": "<svg viewBox=\"0 0 500 300\" xmlns=\"http://www.w3.org/2000/svg\" style=\"max-width:100%;height:auto;font-family:sans-serif\"><defs><marker id=\"arrow\" viewBox=\"0 0 10 10\" refX=\"9\" refY=\"5\" markerWidth=\"8\" markerHeight=\"8\" orient=\"auto\"><path d=\"M0,0 L10,5 L0,10\" fill=\"#666\" opacity=\"0.7\"/></marker></defs><rect x=\"0\" y=\"0\" width=\"500\" height=\"300\" rx=\"10\" fill=\"#f8f9fa\" stroke=\"#dee2e6\" stroke-width=\"1\"/><text x=\"250\" y=\"28\" text-anchor=\"middle\" font-size=\"14\" font-weight=\"bold\" fill=\"#333\">Git Reset</text><rect x=\"10\" y=\"35\" width=\"110\" height=\"25\" rx=\"5\" fill=\"#0070f3\" stroke=\"#0070f3\" stroke-width=\"1.5\"/><text x=\"65\" y=\"51\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Original</text><text x=\"65\" y=\"43\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">Commit A to B to C (</text><text x=\"65\" y=\"54\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">HEAD)</text><line x1=\"120\" y1=\"48\" x2=\"150\" y2=\"48\" stroke=\"#666\" stroke-width=\"1.5\" marker-end=\"url(#arrow)\"/><rect x=\"160\" y=\"35\" width=\"110\" height=\"25\" rx=\"5\" fill=\"#28a745\" stroke=\"#28a745\" stroke-width=\"1.5\"/><text x=\"215\" y=\"51\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">--soft</text><text x=\"215\" y=\"43\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">HEAD to A changes st</text><text x=\"215\" y=\"54\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">aged</text><line x1=\"120\" y1=\"78\" x2=\"150\" y2=\"78\" stroke=\"#666\" stroke-width=\"1.5\" marker-end=\"url(#arrow)\"/><rect x=\"10\" y=\"70\" width=\"110\" height=\"25\" rx=\"5\" fill=\"#dc3545\" stroke=\"#dc3545\" stroke-width=\"1.5\"/><text x=\"65\" y=\"86\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">--mixed</text><text x=\"65\" y=\"78\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">HEAD to A changes un</text><text x=\"65\" y=\"89\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">staged</text><line x1=\"120\" y1=\"108\" x2=\"150\" y2=\"108\" stroke=\"#666\" stroke-width=\"1.5\" marker-end=\"url(#arrow)\"/><rect x=\"10\" y=\"105\" width=\"110\" height=\"25\" rx=\"5\" fill=\"#ffc107\" stroke=\"#ffc107\" stroke-width=\"1.5\"/><text x=\"65\" y=\"121\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">--hard</text><text x=\"65\" y=\"113\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">HEAD to A changes LO</text><text x=\"65\" y=\"124\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">ST</text><rect x=\"10\" y=\"140\" width=\"110\" height=\"25\" rx=\"5\" fill=\"#e83e8c\" stroke=\"#e83e8c\" stroke-width=\"1.5\"/><text x=\"65\" y=\"156\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Reflog</text><text x=\"65\" y=\"159\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">Recovery possible</text><rect x=\"290\" y=\"35\" width=\"190\" height=\"155\" rx=\"5\" fill=\"#17a2b8\" stroke=\"#17a2b8\" stroke-width=\"1.5\"/><text x=\"385\" y=\"51\" text-anchor=\"middle\" font-size=\"11\" font-weight=\"bold\" fill=\"#fff\">Git Reset</text><text x=\"385\" y=\"162\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">Move branch pointer with 3 modes: </text><text x=\"385\" y=\"173\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">--soft --mixed --hard. Dangerous o</text><text x=\"385\" y=\"184\" text-anchor=\"middle\" font-size=\"9\" fill=\"#ddd\">n shared branches.</text><text x=\"240\" y=\"220\" font-size=\"9\" fill=\"#666\" text-anchor=\"middle\">Git Reset: Move HEAD pointer. --soft (keep staged)</text><text x=\"240\" y=\"232\" font-size=\"9\" fill=\"#666\" text-anchor=\"middle\"> --mixed (unstage) --hard (discard all).</text></svg>",
  "codeExamples": [
    {
      "title": "Reset Modes Comparison",
      "useCase": "Visual difference between modes.",
  ...
  "mcqQuestions": [
    {
      ...
      "answer": 1,
      "explanation": "--mixed is the default mode for git reset."
    },
    {
      "question": "What does git reset --soft do?",
      "options": [
        "Discards all changes",
        "Moves HEAD keeps staging and working dir",
        "Resets staging only",
        "Deletes files"
      ],
      "answer": 1,
      "explanation": "--soft moves HEAD but leaves staging and working directory unchanged."
    },
    {
      ...
      "answer": 2,
      "explanation": "--soft is safest as it only moves HEAD without modifying staging or working directory."
    },
    {
      "question": "How do you recover from git reset --hard?",
      "options": [
        "Cannot recover",
      ...
      "answer": 1,
      "explanation": "git reflog shows past HEAD positions for recovery."
    },
    {
      "question": "Why never reset shared branches?",
      "options": [
        "It is slower",
        "It rewrites history breaking other devs",
        "It requires internet",
        "It costs money"
      ],
      "answer": 1,
      "explanation": "Reset rewrites history. Other developers repos will diverge and require force-sync."
    },
    {
      ...
      "answer": 1,
      "explanation": "Resets the file in the staging area to match HEAD (unstages it)."
    },
    {
