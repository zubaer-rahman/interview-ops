  ...
  "mcqQuestions": [
    {
      ...
      "answer": 1,
      "explanation": "Rebase replays commits from one branch onto the tip of another."
    },
    {
      "question": "What is the golden rule of rebasing?",
      "options": [
        ...
        "Rebase every hour",
        "Only rebase with --force"
      ],
      "answer": 1,
      "explanation": "Never rebase commits that have been pushed to a shared branch."
    },
    {
      "question": "What does interactive rebase allow?",
      "options": [
        "Only fast-forward",
        "Squash reword drop reorder commits",
        "Delete remote branches",
        "Create new branches"
      ],
      "answer": 1,
      "explanation": "Interactive rebase (git rebase -i) allows full commit history curation."
    },
    {
      "question": "How do you resolve conflicts during rebase?",
      "options": [
        "One big conflict resolution",
        "Per commit then git rebase --continue",
        "Skip conflicted commits",
        "Delete conflicted files"
      ],
      "answer": 1,
      "explanation": "Rebase resolves conflicts per commit fix add continue."
    },
    {
      "question": "What happens to commit SHAs after a rebase?",
      "options": [
        "They stay the same",
        "They change (new commits)",
        "They are deleted",
        "They get encrypted"
      ],
      "answer": 1,
      "explanation": "Rebase creates new commit objects with new SHAs even for identical content."
    },
    {
      "question": "What is the difference between squash and fixup?",
      "options": [
        "Squash keeps message fixup discards it",
        "Fixup keeps message squash discards",
        "They are the same",
        "Fixup deletes the commit"
      ],
      "answer": 0,
      "explanation": "Squash merges commit messages; fixup discards the squashed commit message."
    },
    {
      "question": "Git Rebase — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "Git Rebase — What improves speed?",
      "options": [
    ...
    {
      "question": "Git Rebase — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "Git Rebase — What ensures quality?",
      "options": [
