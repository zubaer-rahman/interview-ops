export const git_release_mgmt = {
  ...
  "laymanDefinition": "Release management is like a train schedule. Features are passengers waiting at the station (develop branch). Every two weeks a train (release branch) departs. Tickets are checked (QA testing). Passengers who miss the train wait for the next one. Sometimes an emergency express train (hotfix) runs on a special schedule. Each train has a unique number (version tag).",
  "deepDive": [
    {
      "heading": "Semantic Versioning (SemVer)",
      "text": "MAJOR: breaking changes (v2.0.0). MINOR: new features backward compatible (v1.1.0). PATCH: bug fixes backward compatible (v1.0.1). Pre-release: v1.0.0-beta.1 v1.0.0-rc.1. Build metadata: v1.0.0+build.456. Version defined in package.json or equivalent."
    },
    {
      "heading": "Release Branch Strategy",
      "text": "Git Flow: release/v1.2 branched from develop. Only bug fixes and release tasks (no new features). Merged to main (tagged) and develop. GitHub Flow: no release branches. Tag on main after merge. Trunk-Based: release branches from main for stabilization."
    },
    {
      "heading": "Changelog Generation",
      "text": "Conventional commits enable automated changelog. feat: adds to Features section. fix: adds to Bug Fixes. breaking changes: highlighted. Tools: conventional-changelog release-drafter semantic-release. Format: Keep a Changelog. Each release links to diff and release notes."
    },
    {
      "heading": "Release Automation (semantic-release)",
      "text": "Fully automated release process. Analyzes commits since last release. Determines next version (major/minor/patch). Generates changelog. Creates Git tag. Publishes to npm/registry. Creates GitHub Release. Requires conventional commit format."
    },
    {
      "heading": "Hotfix Management",
      "text": "Hotfix branch from main (or production tag). Fix the critical bug. Merge back to main (tag new patch version). Merge back to develop (if using Git Flow). Hotfixes skip the normal release cycle. Version bump: patch version (v1.0.1). Hotfixes should be rare; they indicate release process improvement needed."
    }
  ],
  ...
  "codeExamples": [
    ...
    },
    {
      ...
      "description": "GitHub Actions workflow that creates a release with auto-generated notes when a version tag is pushed."
    },
    {
      "title": "Release Branch Workflow (Git Flow)",
      "useCase": "Manage release branches.",
      "code": "# Start a release\ngit checkout develop\ngit checkout -b release/v1.2.0\n\n# Stabilize (only bug fixes)\ngit commit -m \"fix: correct payment calculation\"\ngit commit -m \"fix: update API rate limit\"\n\n# Version bump in release branch\necho \"v1.2.0\" > VERSION\ngit add VERSION\ngit commit -m \"chore: bump version to 1.2.0\"\n\n# Merge to main and tag\ngit checkout main\ngit merge --no-ff release/v1.2.0\ngit tag -a v1.2.0 -m \"Release v1.2.0\"\ngit push origin main --tags\n\n# Merge back to develop\ngit checkout develop\ngit merge --no-ff release/v1.2.0\n\n# Delete release branch\ngit branch -d release/v1.2.0",
      "description": "Git Flow release branch workflow: branch stabilize merge to main tag and merge back to develop."
    },
    {
      "title": "Hotfix Workflow",
      "useCase": "Emergency production fix.",
      "code": "# From main (or production tag)\ngit checkout main\ngit checkout -b hotfix/critical-security\n\n# Fix the critical bug\ngit commit -m \"fix: patch SQL injection vulnerability\"\n\n# Merge to main and tag patch\ngit checkout main\ngit merge --no-ff hotfix/critical-security\ngit tag -a v1.0.1 -m \"Hotfix v1.0.1\"\ngit push origin main --tags\n\n# If using Git Flow merge to develop too\ngit checkout develop\ngit merge --no-ff hotfix/critical-security\n\n# The hotfix version bump is a PATCH\n# v1.0.0 -> v1.0.1 (not v1.1.0)",
      "description": "Hotfix workflow: branch from main fix merge to main tag patch version and merge back to develop."
    }
  ],
  "mcqQuestions": [
    {
      ...
      "options": [
        ...
        "MAJOR.MINOR.PATCH with meaning",
        "Date-based versions",
        "Build numbers only"
      ],
      "answer": 1,
      "explanation": "SemVer defines version meaning: MAJOR (breaking) MINOR (feature) PATCH (fix)."
    },
    {
      "question": "What is a release branch?",
      "options": [
        "Branch for daily work",
        "Stabilization branch before release",
        "Branch for experiments",
        "Branch for documentation"
      ],
      "answer": 1,
      "explanation": "Release branch stabilizes a release with only bug fixes before merging to main."
    },
    {
      "question": "What does semantic-release do?",
      "options": [
        "Manual release process",
        "Automated version bump changelog tag release",
        "Code formatting",
        "Test runner"
      ],
      "answer": 1,
      "explanation": "semantic-release fully automates the release process from commit analysis to publishing."
    },
    {
      "question": "What triggers a MAJOR version?",
      "options": [
        "Bug fixes",
        "Breaking changes",
        "New features",
      ...
      "answer": 1,
      "explanation": "MAJOR version increments when backward-incompatible changes are introduced."
    },
    {
      "question": "What is a hotfix?",
      "options": [
        "A new feature",
        "An urgent production bug fix",
        "A code refactor",
        "A version upgrade"
      ],
      "answer": 1,
      "explanation": "Hotfix is an urgent fix for a production issue branched from main and tagged as patch."
    },
    {
      "question": "What should release notes include?",
      "options": [
        "Only version number",
      ...
      "answer": 1,
      "explanation": "Release notes should summarize features bug fixes and breaking changes for the release."
    },
    {
