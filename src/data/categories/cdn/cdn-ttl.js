export const cdn_ttl = {
  ...
  "codeExamples": [
    ...
    },
    {
      ...
      "description": "Nginx proxy cache TTL configuration with proxy_cache_valid overriding origin headers."
    }
  ],
  "mcqQuestions": [
    {
      ...
      "answer": 1,
      "explanation": "TTL = Time To Live — how long content is cached."
    },
    {
      "question": "How is TTL typically set?",
      "options": [
        "DNS configuration",
      ...
      "answer": 1,
      "explanation": "TTL is set via the Cache-Control max-age header in seconds."
    },
    {
      "question": "What happens when TTL expires?",
      "options": [
        "Content is deleted from disk",
        "Content becomes stale, next request re-fetches",
        "Server restarts",
        "Cache size doubles"
      ],
      "answer": 1,
      "explanation": "After TTL expiry, the next request triggers a cache miss and re-fetch from origin."
    },
    {
      "question": "What TTL should versioned assets use?",
      "options": [
        "1 hour",
        "1 day",
      ...
      "answer": 2,
      "explanation": "Versioned assets should use 1 year TTL with immutable for optimal caching."
    },
    {
      "question": "What does MinTTL do in CloudFront?",
      "options": [
        "Sets minimum cache duration regardless of origin headers",
        "Sets maximum cache duration",
        "Default TTL when origin has none",
        "Disables caching"
      ],
      "answer": 0,
      "explanation": "MinTTL is the minimum time CloudFront caches content, overriding shorter origin TTLs."
    },
    {
      "question": "What is the trade-off with longer TTL?",
      "options": [
        "Better performance vs. potential stale content",
        "More origin load vs. fresh content",
        "Lower CHR vs. faster updates",
        "More cost vs. better performance"
      ],
      "answer": 0,
      "explanation": "Longer TTL improves performance but risks serving stale content to users."
    }
  ]
};
