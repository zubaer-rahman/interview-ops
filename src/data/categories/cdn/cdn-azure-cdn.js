  ...
  "mcqQuestions": [
    {
      ...
      "answer": 1,
      "explanation": "Azure CDN tiers are Microsoft, Akamai, and Verizon."
    },
    {
      "question": "Which tier has the most PoPs?",
      "options": [
        "Microsoft (200+)",
        "Akamai (2500+)",
        "Verizon (150+)",
      ...
      "answer": 1,
      "explanation": "Akamai tier has 2500+ PoPs globally."
    },
    {
      "question": "What is DSA in Azure CDN?",
      "options": [
        "Data storage accelerator",
        "Dynamic Site Acceleration",
        "Direct server access",
        "Data security appliance"
      ],
      "answer": 1,
      "explanation": "DSA is Dynamic Site Acceleration for non-cacheable content."
    },
    {
      "question": "Which Azure service is commonly used with CDN?",
      "options": [
        "Azure Functions",
        "Blob Storage",
        "Azure DevOps",
      ...
      "answer": 1,
      "explanation": "Azure Blob Storage is commonly used as CDN origin."
    },
    {
      "question": "What does geo-filtering do?",
      "options": [
        "Block by IP",
        "Block by country",
        "Block by user agent",
      ...
      "answer": 1,
      "explanation": "Geo-filtering restricts content by country code."
    },
    {
      "question": "What is Azure Front Door?",
      "options": [
        "Older CDN product",
        "Modern CDN + WAF + global load balancer",
        "DNS service",
        "Firewall service"
      ],
      "answer": 1,
      "explanation": "Azure Front Door is the modern successor combining CDN, WAF, and global load balancing."
    }
  ]
};
