export const cdn_geo_routing = {
  ...
  "deepDive": [
    {
      "heading": "DNS-Based Geo Routing",
      "text": "DNS server returns different IP addresses based on the client\\'s resolver location. Uses GeoIP databases to map IPs to regions. Simple to implement. Updates can be slow (DNS TTL). Less precise than Anycast. Used by: Akamai, Azure CDN, legacy CDNs."
    },
    {
      "heading": "Anycast Routing",
      "text": "Multiple edge servers share the same IP address. BGP (Border Gateway Protocol) automatically routes traffic to the nearest server announcing that IP. Fast failover (if one PoP goes down, BGP converges to next nearest). More precise and resilient. Used by: Cloudflare, Fastly, CloudFront."
    },
    {
      "heading": "Geo Routing Factors",
      "text": "Latency: primary metric (measured via RTT). Server load: avoid overloaded edge servers. Cache availability: prefer edge with cached content. Origin health: route around unhealthy origins. Network conditions: avoid congested paths. Cost: some routes may be cheaper. Custom rules: route specific content to specific regions."
    },
    {
      "heading": "Real-Time Traffic Steering",
      "text": "Advanced CDNs use real-time monitoring to detect network congestion, packet loss, and latency spikes. Traffic is dynamically rerouted to avoid problem areas. Fastly uses real-time data to steer traffic around internet weather events. Cloudflare Argo Smart Routing optimizes paths in real-time."
    },
    {
      "heading": "Geo Routing for Origin Traffic",
      "text": "CDNs can also route requests to the nearest origin server (multi-region origins). User in Europe -> nearest European edge -> nearest European origin. Requires origin servers in multiple regions. Benefits: lower latency for dynamic cache misses, compliance (data sovereignty)."
    }
  ],
  ...
  "mcqQuestions": [
    {
      "question": "What are the two main geo routing methods?",
      "options": [
        "DNS-based and Anycast",
        "HTTP and HTTPS",
        "TCP and UDP",
        "IPv4 and IPv6"
      ],
      "answer": 0,
      "explanation": "The two main methods are DNS-based geo routing and Anycast routing."
    },
    {
      "question": "How does Anycast routing work?",
      "options": [
        "Different IP per PoP",
        "Multiple PoPs share one IP, BGP routes to nearest",
        "DNS returns different IPs",
        "HTTP redirects"
      ],
      "answer": 1,
      "explanation": "Anycast shares one IP across multiple PoPs; BGP routes to the nearest."
    },
    {
      "question": "What is the advantage of Anycast over DNS routing?",
      "options": [
        "Slower updates",
        "Faster failover and more precise",
        "More complex",
        "Less reliable"
      ],
      "answer": 1,
      "explanation": "Anycast provides faster failover and more precise routing than DNS-based."
    },
    {
      "question": "What is Argo Smart Routing?",
      "options": [
        "Cloudflare DNS service",
        "Real-time traffic path optimization",
        "CDN caching product",
        "Compression algorithm"
      ],
      "answer": 1,
      "explanation": "Argo Smart Routing optimizes traffic paths in real-time."
    },
    {
      "question": "What factors affect geo routing decisions?",
      "options": [
        "Only distance",
        "Latency, load, cache, network health",
        "Only server load",
        "Only cache availability"
      ],
      "answer": 1,
      "explanation": "Geo routing considers latency, server load, cache state, and network health."
    },
    {
      "question": "What is multi-region origin routing?",
      "options": [
        "Multiple CDN providers",
        "Routing to nearest origin server",
        "Multiple DNS providers",
        "Multiple SSL certificates"
      ],
      "answer": 1,
      "explanation": "Multi-region origin routes to the nearest origin server for lower latency."
    }
  ]
};
