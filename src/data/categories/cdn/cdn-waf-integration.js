export const cdn_waf_integration = {
  "id": "cdn-waf-integration",
  ...
  "laymanDefinition": "WAF integrated with a CDN is like having a security checkpoint at the entrance of a building, not just at each office door. The security guard checks for weapons, suspicious packages, and known threats before anyone enters. If someone looks suspicious, they are stopped at the entrance, never reaching the offices (origin).",
  "deepDive": [
    {
      "heading": "WAF at Edge vs Origin",
      "text": "Edge WAF: inspects at CDN edge, blocks before origin. Zero origin load from blocked requests. Lower latency (no origin trip). Origin WAF: inspects at application server. More context-aware but consumes origin resources. CDN WAF is the industry standard."
    },
    {
      "heading": "Managed Rule Sets",
      "text": "Pre-built rule sets maintained by CDN vendor. OWASP Top 10 rules (CRS - Core Rule Set). Vendor-specific: Cloudflare Managed, AWS Managed, Fastly Signal Sciences. Regular rule updates from vendor. Customizable (paranoia levels, anomaly thresholds)."
    },
    {
      "heading": "Custom WAF Rules",
      "text": "User-defined rules for application-specific threats. Match on: URI, headers, body, cookies, IP, country, device. Actions: block, challenge, log, rate limit, bypass. Use regex or DSL (VCL, Lua). Priority ordering matters. Rule testing and dry-run modes available."
    },
    {
      "heading": "WAF Logging and Analytics",
      "text": "Comprehensive logging of blocked/allowed requests. Attack analytics dashboard. Top attack vectors, sources, and targets. Real-time alerts for spikes in blocked traffic. Logs stored for compliance (SIEM integration via log streaming)."
    },
    {
      "heading": "WAF Performance Considerations",
      "text": "Edge WAF adds minimal latency (microseconds to low milliseconds). Rule count and complexity affect performance. Heavy regex can slow processing. WAF bypass for static cached resources (images, CSS) reduces unnecessary inspection. Parallel vs sequential rule evaluation."
    }
  ],
  "interviewAnswer": "CDN WAF inspects HTTP traffic at the edge against managed and custom rules, blocking SQLi, XSS, and OWASP Top 10 threats before they reach origin. It offers managed rule sets, custom rules, rate limiting, ML-based detection, and comprehensive logging.",
  "interviewQuestions": [
    {
  ...
  "mcqQuestions": [
    {
      ...
      "answer": 1,
      "explanation": "WAF protects against SQLi, XSS, and other OWASP Top 10 threats."
    },
    {
      "question": "Where is the WAF located in a CDN?",
      "options": [
      ...
      "answer": 1,
      "explanation": "CDN WAF is at the edge, inspecting traffic before origin."
    },
    {
      "question": "What is OWASP CRS?",
      "options": [
        "Caching rule system",
        "Core Rule Set for WAF",
        "Content routing service",
        "Certificate revocation system"
      ],
      "answer": 1,
      "explanation": "OWASP CRS is the Core Rule Set for WAF."
    },
    {
      "question": "What is WAF paranoia level?",
      "options": [
      ...
      "answer": 1,
      "explanation": "Paranoia level controls WAF sensitivity from 1 (low) to 4 (high)."
    },
    {
      "question": "What should you do before enabling custom WAF rules?",
      "options": [
        "Enable immediately",
      ...
      "answer": 1,
      "explanation": "Always test custom rules in log mode before enabling blocking."
    },
    {
      "question": "What is a WAF bypass?",
      "options": [
        "Skipping WAF for certain paths",
        "Bypassing origin",
        "Bypassing cache",
        "Bypassing DNS"
      ],
      "answer": 0,
      "explanation": "WAF bypass skips inspection for specific paths or resource types."
    }
  ]
};
