export const log_shipping = {
  ...
  "codeExamples": [
    ...
    },
    {
      ...
      "description": "Bull queue provides application-level log buffering with retries, backoff, and persistence."
    },
    {
      "title": "Promtail for Grafana Loki",
      "useCase": "Kubernetes log shipping to Loki.",
      "code": "# promtail.yaml\nserver:\n  http_listen_port: 3101\n\npositions:\n  filename: /var/log/positions.yaml\n\nclients:\n  - url: http://loki:3100/loki/api/v1/push\n\nscrape_configs:\n- job_name: kubernetes-pods\n  kubernetes_sd_configs:\n  - role: pod\n  pipeline_stages:\n  - docker: {}\n  - cri: {}\n  - regex:\n      expression: '^(?P<namespace>\\S+)\n        (?P<pod_name>\\S+)\n        (?P<container_name>\\S+)\n        .*'\n  - labels:\n      namespace:\n      pod_name:\n      container_name:",
      "description": "Promtail auto-discovers Kubernetes pods and ships logs with label metadata to Grafana Loki."
    }
  ],
  "mcqQuestions": [
    {
      ...
      "options": [
        "A log database",
        "An agent that reliably transfers logs to a central platform",
        "A log visualizer",
        "A log parser"
      ],
      "answer": 1,
      "explanation": "A log shipper is an agent that collects and reliably transfers logs from source to destination."
    },
    {
      "question": "Which shipper is ultra-lightweight (~450KB)?",
      "options": [
        "Filebeat",
        "Fluentbit",
        "Logstash",
      ...
      "answer": 1,
      "explanation": "Fluentbit is written in C and designed for resource-constrained environments."
    },
    {
      "question": "How do shippers handle network failures?",
      "options": [
        "Stop logging",
        "Buffer logs and retry",
        "Delete old logs",
        "Switch to file storage"
      ],
      "answer": 1,
      "explanation": "Shippers buffer logs to disk and retry with exponential backoff when the destination is down."
    },
    {
      "question": "What is a DaemonSet in Kubernetes logging?",
      "options": [
        "A pod per deployment",
        "A pod per node collecting all node logs",
        "A sidecar per pod",
        "A standalone service"
      ],
      "answer": 1,
      "explanation": "DaemonSet runs one shipper per node to collect logs from all pods on that node."
    },
    {
      "question": "What protocol should log shipping use?",
      "options": [
        "HTTP",
        "TLS/HTTPS",
        "FTP",
      ...
      "answer": 1,
      "explanation": "Log shipping should use TLS encryption to protect sensitive data in transit."
    },
    {
      "question": "What delivery guarantee do shippers provide?",
      "options": [
        "Exactly-once",
        "At-least-once",
        "At-most-once",
      ...
      "answer": 1,
      "explanation": "Most shippers provide at-least-once delivery — logs may duplicate but will not be lost."
    },
    {
      "question": "Log Shipping — What reduces errors most?",
      "options": [
        "Automation",
        "Manual processes",
        "Rushing",
    ...
    {
      "question": "Log Shipping — What improves speed?",
      "options": [
    ...
    {
      "question": "Log Shipping — What is key for monitoring?",
      "options": [
    ...
    {
      "question": "Log Shipping — What ensures quality?",
      "options": [
