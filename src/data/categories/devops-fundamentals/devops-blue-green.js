export const devops_blue_green = {
  ...
  "laymanDefinition": "Blue-Green is like two identical bridges across a river. Traffic uses Blue. You build Green alongside. When Green is tested, switch all traffic instantly. If problems, switch back to Blue. Traffic never stops.",
  "deepDive": [
    {
      "heading": "Architecture",
      "text": "Two identical environments. Load balancer controls traffic direction. At switch time, router reconfigures to send all traffic to Green. Old Blue stays ready for rollback."
    },
    {
      "heading": "Database Challenges",
      "text": "Schema changes must be backward-compatible. Phase migrations: add columns before switch, remove old after. Green connects to same DB or cloned replica. Best: changes compatible with N-1 version."
    },
    {
      "heading": "Switch and Rollback",
      "text": "Switch: update DNS/load balancer to Green. Instant for internal LBs; DNS has propagation delay (use low TTL). Rollback: switch traffic back to Blue. Blue still running. No redeployment."
    },
    {
      "heading": "Kubernetes Blue-Green",
      "text": "Two deployments (blue, green) with labels. Service selector switches between them. Tools: Argo Rollouts, Flagger automate traffic switching."
    }
  ],
  "interviewAnswer": "Blue-Green provides zero-downtime deployments with instant rollback at double infrastructure cost. Database migrations must be backward-compatible. Use for critical services where downtime is unacceptable.",
  "interviewQuestions": [
    {
    ...
    },
    {
      ...
      "answer": "Zero-downtime deployments and instant rollback by switching traffic back to Blue."
    },
    {
      "question": "What is the main challenge?",
      "answer": "Double infrastructure cost during transition. Both environments run simultaneously."
    },
    {
      "question": "How is rollback handled?",
      "answer": "Switch traffic back to the still-running Blue environment. No redeployment needed."
    },
    {
      "question": "How to handle DB migrations?",
      "answer": "Backward-compatible schema changes. Phase migrations: add before switch, remove old after."
    },
    {
  ...
  "mcqQuestions": [
    {
      "question": "What is the main benefit of Blue-Green?",
      "options": [
        "Lower cost",
      ...
      "answer": 1,
      "explanation": "Blue-Green provides zero-downtime deployments and instant rollback by switching traffic."
    },
    {
      ...
      "answer": 1,
      "explanation": "Blue-Green requires two full environments, doubling infrastructure costs during transition."
    },
    {
      "question": "How does Blue-Green handle rollback?",
      "options": [
      ...
      "answer": 1,
      "explanation": "Rollback is instant — switch traffic back to the still-running Blue environment."
    },
    {
