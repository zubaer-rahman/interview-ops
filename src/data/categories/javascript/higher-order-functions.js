export const higher_order_functions = {
  ...
  "mcqQuestions": [
    ...
    },
    {
      ...
      "options": [
        ...
        "Because they can be assigned, passed, and returned like any value",
        "Because they have priority",
        "Because they execute immediately"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        ...
        "A HOF that ensures the wrapped function runs only once",
    ...
    },
    {
      ...
      "options": [
        "Creates a pipeline where data flows left-to-right through functions",
