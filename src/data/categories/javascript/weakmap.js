export const weakmap = {
  ...
  "mcqQuestions": [
    ...
    },
    {
      ...
      "options": [
        "Performance reasons",
        "Keys can be GC'd at any time, making size unreliable",
        "It was forgotten in the spec",
        "Memory constraints"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "Faster performance",
        "Automatic garbage collection of entries when keys are no longer referenced",
    ...
    },
    {
      ...
      "options": [
        "The entry stays until explicitly deleted",
    ...
    },
    {
      ...
      "options": [
        "Yes, with wm.keys()",
        "No, WeakMap doesn't expose its keys",
        "Yes, with for...of",
        "Only if you know the keys"
      ],
      "answer": 1,
