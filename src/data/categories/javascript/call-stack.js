  ...
  "mcqQuestions": [
    ...
    },
    {
      ...
      "options": [
        ...
        "The execution context of a function call on the stack",
        "The global object",
        "A closure's memory allocation"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "Too many variables in a function",
    ...
    },
    {
      ...
      "options": [
        "Only the current frame is removed",
        "The stack unwinds until it reaches the global context or a catch block",
        "The stack freezes for debugging",
        "All frames above the error are moved to the heap"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "The timer needs time to start",
        "The callback must wait for the Call Stack to be empty",
        "setTimeout always has a 1ms minimum delay",
    ...
    },
    {
      ...
      "options": [
        "Both execute the same way on the stack",
        "Sync code executes directly on the stack; async callbacks wait in queues until the stack is empty",
        "Async code has its own separate stack",
        "Sync code uses the heap instead of the stack"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        ...
        "A while(true) loop",
        "An array with 1 million elements"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        ...
        "Reusing the current stack frame when a function's last action is calling another function",
        "Caching function results",
        "Inlining small functions for performance"
      ],
      "answer": 1,
