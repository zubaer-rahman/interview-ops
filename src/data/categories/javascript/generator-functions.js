export const generator_functions = {
  ...
  "mcqQuestions": [
    ...
    },
    {
      ...
      "options": [
        "Yes, with while(true) and yield",
        "No, generators must terminate",
        "Only with arrays",
    ...
    },
    {
      ...
      "options": [
        ...
        "Terminates the generator and sets done to true",
    ...
    },
    {
      ...
      "options": [
        "Yes, generators implement the iterable protocol",
        "No, generators are not iterable",
        "Only if they return arrays",
        "Only with async generators"
      ],
      "answer": 0,
    ...
    },
    {
      "question": "Are generators synchronous or asynchronous?",
      "options": [
        "Synchronous (they pause and resume within the same thread)",
        "Asynchronous (they run on separate threads)",
