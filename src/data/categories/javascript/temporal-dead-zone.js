export const temporal_dead_zone = {
  ...
  "mcqQuestions": [
    ...
    },
    {
      ...
      "options": [
        ...
        "let, const",
        "var only",
        "All variables including function declarations"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "Begins at declaration, ends at assignment",
        "Begins at scope entry, ends at declaration",
        "Begins at scope entry, ends at scope exit",
        "Begins at hoisting, ends at initialization"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        ...
        "To catch bugs where variables are used before declaration",
        "To replace var entirely",
        "To enable block scoping"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "No, classes are fully hoisted",
        "Yes, like let and const",
        "Only in strict mode",
