export const this_keyword = {
  ...
  "mcqQuestions": [
    ...
    },
    {
      ...
      "options": [
        "Yes, .call() works on all functions",
        "No, arrow functions ignore the first argument of .call()",
        "Only if the arrow function is not strict",
