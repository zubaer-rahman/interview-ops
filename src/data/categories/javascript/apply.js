  ...
  "mcqQuestions": [
    {
      ...
      "options": [
        ...
        "Immediately invokes a function with specified this and array of args",
        "Returns a new array",
    ...
    },
    {
      ...
      "options": [
        ...
        "It uses the arguments from the previous call",
    ...
    },
    {
      ...
      "options": [
        "arr1.concat.apply(arr1, arr2)",
        "Array.prototype.push.apply(arr1, arr2)",
        "arr1.apply(arr2)",
        "arr1.merge.apply(arr1, arr2)"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        ...
        "Any array-like object with length and indices",
        "Only strings"
      ],
      "answer": 2,
    ...
    },
    {
      ...
      "options": [
        "new Fn.apply(obj, args)",
        "Fn.apply(new obj, args)",
        "Reflect.construct(Fn, args)",
        "You cannot use apply() with constructors"
      ],
      "answer": 2,
