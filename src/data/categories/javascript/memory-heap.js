  ...
  "mcqQuestions": [
    ...
    },
    {
      ...
      "options": [
        ...
        "Root references (global object, stack variables)",
    ...
    },
    {
      ...
      "options": [
        ...
        "Using const",
        "Accidentally assigning to an undeclared variable",
        "Using strict mode"
      ],
      "answer": 2,
    ...
    },
    {
      ...
      "options": [
        ...
        "WeakMap allows its keys to be garbage collected; Map does not",
        "Map stores values on the stack",
        "WeakMap can only store strings as keys"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        ...
        "At engine-determined intervals (during idle time, allocations, etc.)",
        "Immediately when a variable goes out of scope",
        "Only when manually called via gc()"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "They are immediately freed",
        "They become eligible for GC if no longer reachable",
        "They are moved to the stack",
    ...
    },
    {
      ...
      "options": [
        "A sorting algorithm",
        "A garbage collection algorithm that marks reachable objects and sweeps unmarked ones",
    ...
    },
    {
      ...
      "options": [
        ...
        "Generations in V8's generational heap: young objects (New) and survivors (Old)",
        "Two separate JavaScript engines",
        "Stack and Heap"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "A DOM element that is too large",
        "A DOM element removed from the document but still referenced by JavaScript",
        "A DOM element with too many event listeners",
        "A DOM element that was never added to the document"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "Yes, instantly",
        "No, it only removes one reference. The object becomes eligible for GC on the next GC cycle",
        "No, null has no effect on memory",
