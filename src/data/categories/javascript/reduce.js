export const reduce = {
  ...
  "mcqQuestions": [
    ...
    },
    {
      "question": "What is the difference between reduce and reduceRight?",
      "options": [
        "reduceRight is faster",
        "reduceRight iterates from right to left",
        "reduceRight doesn't need initialValue",
        "They are identical"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "arr.reduce((max, v) => Math.max(max, v), -Infinity)",
        "arr.reduce((max, v) => v > max ? v : max)",
        "arr.reduce((max, v) => v, -Infinity)",
        "Both A and B"
      ],
      "answer": 3,
    ...
    },
    {
      ...
      "options": [
        "Reduce is faster for all cases",
        "Reduce can do both in one pass (more efficient)",
        "Reduce doesn't need a callback",
        "Reduce always returns a number"
      ],
      "answer": 1,
