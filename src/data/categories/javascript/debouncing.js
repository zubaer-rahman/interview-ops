  ...
  "mcqQuestions": [
    {
      ...
      "options": [
        ...
        "To delay execution until after a period of inactivity",
        "To ensure a function runs exactly once",
        "To prevent errors in async code"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "To limit function execution to at most once per time interval",
        "To make functions run as fast as possible",
        "To batch multiple calls into one",
    ...
    },
    {
      ...
      "options": [
        "It cancels the previous timer, resetting the delay",
    ...
    },
    {
      ...
      "options": [
        "Leading fires immediately on first call, trailing fires after delay",
        "Leading fires after delay, trailing fires immediately",
        "Leading is for scroll, trailing is for resize",
    ...
    },
    {
      ...
      "options": [
        ...
        "rAF synchronizes with the browser's render cycle and pauses when tab is inactive",
        "rAF cannot be cancelled",
        "rAF runs once per second"
      ],
      "answer": 1,
    ...
    },
    {
      ...
      "options": [
        "Memory leaks from pending timers holding references",
        "The function never runs",
        "The page crashes",
        "Event listeners stop working"
      ],
      "answer": 0,
    ...
    },
    {
      ...
      "options": [
        ...
        "Throttle with 100ms limit",
        "requestAnimationFrame without limit",
