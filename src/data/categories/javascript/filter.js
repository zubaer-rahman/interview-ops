  ...
  "mcqQuestions": [
    ...
    },
    {
      ...
      "options": [
        ...
        "They are identical",
        "find returns all matches; filter returns the first",
        "filter returns a boolean; find returns an array"
      ],
      "answer": 0,
    ...
    },
    {
      ...
      "options": [
        "Yes, it removes elements",
        "No, it returns a new array",
        "Only if the callback modifies elements",
        "Yes, it reverses it"
      ],
      "answer": 1,
    ...
    },
    {
      "question": "Can filter be chained with map?",
      "options": [
        "Yes: arr.filter(fn).map(fn)",
        "No, filter doesn't return an array",
    ...
    },
    {
      ...
      "options": [
        "arr.filter(obj => obj.property === value)",
        "arr.filter(obj.property === value)",
        "arr.find(obj => obj.property === value)",
    ...
    },
    {
      ...
      "options": [
        ...
        "The same length as the original (if all pass)",
        "The original length minus one",
        "Unlimited"
      ],
      "answer": 1,
