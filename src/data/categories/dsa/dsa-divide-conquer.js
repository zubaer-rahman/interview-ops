export const dsa_divide_conquer = {
  ...
  "laymanDefinition": "Divide and Conquer is like organizing a large group project. The manager divides the work into independent tasks, assigns each to a team (conquer), then combines the results into the final deliverable (combine). Each team works independently without needing to coordinate.",
  "deepDive": [
    {
      "heading": "D&C vs DP",
      "text": "D&C: subproblems are independent (non-overlapping). No memoization needed. Examples: MergeSort, QuickSort, Binary Search. DP: subproblems overlap. Memoization or tabulation needed. Examples: Fibonacci, LCS, Knapsack."
    },
    {
      "heading": "Master Theorem",
      "text": "T(n) = aT(n/b) + f(n). a: number of subproblems. b: factor input shrinks. f(n): cost of divide+combine. Three cases compare f(n) to n^(log_b a). Used to analyze D&C recurrence relations."
    },
    {
      "heading": "MergeSort Analysis",
      "text": "Divide: O(1) find middle. Conquer: 2T(n/2) sort halves. Combine: O(n) merge. Recurrence: T(n) = 2T(n/2) + O(n). Master theorem case 2: O(n log n). Space: O(n) for merge."
    },
    {
      "heading": "Applications",
      "text": "MergeSort (sorting), QuickSort (sorting), Binary Search (search), Closest Pair (geometry), Strassen (matrix multiplication), Karatsuba (multiplication), FFT (polynomials)."
    }
  ],
  "interviewAnswer": "Divide and Conquer is a powerful problem-solving paradigm. The key insight: independent subproblems make it efficient and easy to parallelize. Use Master Theorem for complexity analysis. MergeSort guarantees O(n log n). QuickSort is faster in practice but has O(n^2) worst case.",
  "interviewQuestions": [
    {
      "question": "What is Divide and Conquer?",
      "answer": "A paradigm that recursively breaks a problem into independent subproblems, solves them, and combines results."
    },
    {
    ...
    {
      "question": "What is the difference between D&C and DP?",
      "answer": "D&C: independent (non-overlapping) subproblems. DP: overlapping subproblems."
    },
    {
      "question": "What does the Master Theorem analyze?",
      "answer": "Recurrence relations of the form T(n) = aT(n/b) + f(n)."
    },
    {
      "question": "What is the recurrence for MergeSort?",
      "answer": "T(n) = 2T(n/2) + O(n). Solved: O(n log n)."
    },
    {
      "question": "What is QuickSort\\'s worst case?",
      "answer": "O(n^2) when pivot is min or max (already sorted array)."
    },
    {
  ...
  "codeExamples": [
    ...
    },
    {
      ...
      "description": "Closest pair O(n log n) D&C."
    },
    {
      "title": "Maximum Subarray (D&C)",
      "useCase": "D&C approach for max subarray.",
      ...
      "description": "Maximum subarray D&C O(n log n)."
    }
  ],
  "mcqQuestions": [
    {
      "question": "What are the three D&C steps?",
      "options": [
      ...
      "answer": 1,
      "explanation": "Divide, Conquer, Combine."
    },
    {
      "question": "Difference between D&C and DP?",
      "options": [
        "D&C has overlapping subproblems",
        "D&C has independent subproblems",
        "Same",
        "D&C uses memoization"
      ],
      "answer": 1,
      "explanation": "D&C subproblems are independent."
    },
    {
      "question": "MergeSort recurrence?",
      "options": [
        "T(n) = 2T(n/2) + O(1)",
        "T(n) = 2T(n/2) + O(n)",
        "T(n) = T(n-1) + O(n)",
    ...
    },
    {
      ...
      "answer": 1,
      "explanation": "O(n^2) when pivot is extreme (sorted array)."
    },
    {
    ...
    {
      "question": "What analyzes D&C recurrences?",
      "options": [
        "Master Theorem",
        "Greedy choice",
        "Exchange argument",
      ...
      "answer": 0,
      "explanation": "Master Theorem analyzes D&C recurrences."
    }
  ]
};
