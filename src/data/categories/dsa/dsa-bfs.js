export const dsa_bfs = {
  ...
  "laymanDefinition": "BFS is like a search party spreading out from a starting point. Everyone takes one step outward, then another, then another. The first person to find the target took the shortest route. It is like ripples spreading from a stone dropped in water.",
  "deepDive": [
    {
      "heading": "BFS Algorithm",
      "text": "Start at root. Add to queue. Mark visited. While queue not empty: dequeue, process, enqueue all unvisited neighbors. Guarantees shortest path in unweighted graphs because all edges have equal weight."
    },
    {
      "heading": "BFS vs DFS",
      "text": "BFS: queue, level-order, shortest path, O(V+E) space. DFS: stack, depth-first, not guaranteed shortest, O(V) space. BFS for shortest paths, DFS for topological sort and cycle detection."
    },
    {
      "heading": "BFS Applications",
      "text": "Shortest path in unweighted graph. Web crawling. Social network degrees of separation. GPS navigation. Connected components. Level-order tree traversal."
    },
    {
      "heading": "BFS Variation: 0-1 BFS",
      "text": "For edge weights 0 or 1, use deque. If weight is 0, push to front. If 1, push to back. Still O(V+E). Multi-source BFS: start from multiple nodes simultaneously."
    }
  ],
  "interviewAnswer": "BFS is the go-to for shortest path in unweighted graphs and level-order processing. Queue-based, O(V+E). Use when you need the minimum number of steps/edges. BFS on grids (2D arrays) is extremely common in coding interviews.",
  "interviewQuestions": [
    {
      "question": "What is BFS?",
      "answer": "Breadth-First Search — explores a graph level by level using a queue."
    },
    {
  ...
  "codeExamples": [
    {
      ...
      "description": "Standard BFS O(V+E)."
    },
    {
      ...
      "description": "Shortest path in binary matrix BFS O(n^2)."
    },
    {
      "title": "Word Ladder",
      "useCase": "BFS transforming words.",
      ...
      "description": "Word ladder BFS O(n * l * 26)."
    },
    {
      "title": "Rotting Oranges",
      "useCase": "Multi-source BFS.",
      ...
      "description": "Rotting oranges — multi-source BFS."
    }
  ],
  "mcqQuestions": [
    {
    ...
    },
    {
      ...
      "answer": 0,
      "explanation": "BFS: O(V+E) for graphs."
    },
    {
      "question": "What does BFS guarantee in unweighted graphs?",
      "options": [
        "Shortest path",
      ...
      "answer": 0,
      "explanation": "BFS guarantees shortest path."
    },
    {
      "question": "BFS space complexity?",
      "options": [
        "O(1)",
        "O(V)",
        "O(log V)",
    ...
    },
    {
      ...
      "answer": 1,
      "explanation": "BFS = queue, DFS = stack."
    },
    {
      "question": "What is multi-source BFS?",
      "options": [
      ...
      "answer": 1,
      "explanation": "Multi-source BFS starts from multiple nodes."
    }
  ]
};
