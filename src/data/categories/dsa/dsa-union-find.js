export const dsa_union_find = {
  ...
  "laymanDefinition": "Union Find is like managing friend groups at a party. Each person starts alone. When two people become friends, their groups merge (union). To check if two people are in the same group, you ask \"who is the group leader?\" (find). Path compression means everyone remembers the leader directly.",
  "deepDive": [
    {
      "heading": "Data Structure",
      "text": "Array of parents: parent[i] = j means i points to j. Root: parent[i] = i. Initially, each element is its own parent (singleton set). Find follows parent pointers until reaching the root."
    },
    {
      "heading": "Path Compression",
      "text": "During find, set parent of each visited node directly to the root. Flattens the tree. Makes subsequent finds O(1). Implemented recursively or iteratively. Critical for near-O(1) amortized performance."
    },
    {
      "heading": "Union by Rank/Size",
      "text": "Rank: depth of tree. Union attaches shallower tree under deeper tree. Size: number of elements. Union attaches smaller size under larger size. Prevents tall trees. Without this, union could create O(n) chains."
    },
    {
      "heading": "Applications",
      "text": "Connected components in graphs. Kruskal\\'s MST algorithm. Number of islands (dynamic). Percolation. Redundant connections. Detecting cycles in undirected graphs. Friend circles / social networks."
    }
  ],
  "interviewAnswer": "Union Find is the go-to structure for dynamic connectivity problems. Both optimizations (path compression + union by rank) are essential for near-O(1) performance. Master the implementation pattern: parent array with find() and union() methods.",
  "interviewQuestions": [
    {
      "question": "What is Union Find?",
      "answer": "A data structure tracking disjoint sets, supporting find and union operations."
    },
    {
      "question": "What does Find do?",
      "answer": "Returns the representative (root) of the set containing an element."
    },
    {
      "question": "What does Union do?",
      "answer": "Merges two sets into one."
    },
    {
      "question": "What is path compression?",
      "answer": "During find, point all visited nodes directly to the root."
    },
    {
      "question": "What is union by rank?",
      "answer": "Attach the shallower tree under the deeper tree to maintain balance."
    },
    {
      "question": "What is the amortized time complexity?",
      "answer": "Inverse Ackermann \\u03b1(n) — effectively O(1) for all practical input sizes."
    },
    {
      "question": "What algorithm uses Union Find?",
      "answer": "Kruskal\\'s Minimum Spanning Tree algorithm."
    },
    {
      "question": "How is Union Find initialized?",
      "answer": "Each element is its own parent: parent[i] = i."
    },
    {
      "question": "What is a use case for Union Find?",
      "answer": "Dynamic connectivity \\u2014 number of connected components as edges are added."
    },
    {
      "question": "Can Union Find detect cycles?",
      "answer": "Yes \\u2014 if union finds two elements already in same set, adding edge creates cycle."
    }
  ],
  ...
  "codeExamples": [
    ...
    },
    {
      ...
      "description": "Kruskal MST O(E log E)."
    },
    {
      "title": "Redundant Connection",
      "useCase": "Find edge creating cycle.",
      "code": "function findRedundantConnection(edges) {\n  const uf = new UnionFind(edges.length);\n  for (const [u, v] of edges)\n    if (!uf.union(u, v)) return [u, v];\n  return [];\n}",
      "description": "First edge connecting already-connected nodes is redundant."
    },
    {
      "title": "Number of Islands II",
      "useCase": "Dynamic island counting.",
      ...
      "description": "Dynamic number of islands using DSU."
    }
  ],
  "mcqQuestions": [
    {
      "question": "What are the two Union Find operations?",
      "options": [
        "Push and Pop",
        "Find and Union",
        "Add and Remove",
    ...
    },
    {
      ...
      "answer": 1,
      "explanation": "Points all visited nodes to root."
    },
    {
      "question": "What does union by rank do?",
      "options": [
        "Flatten tree",
        "Attach shallow under deep",
        "Compress path",
        "Increase size"
      ],
      "answer": 1,
      "explanation": "Attaches shallower tree under deeper tree."
    },
    {
      "question": "Amortized time complexity?",
      "options": [
        "O(1)",
        "O(log n)",
        "O(n)",
      ...
      "answer": 3,
      "explanation": "Inverse Ackermann \\u03b1(n) — effectively near O(1)."
    },
    {
      "question": "What algorithm uses DSU?",
      "options": [
        "Dijkstra",
        "Kruskal MST",
        "BFS",
      ...
      "answer": 1,
      "explanation": "Kruskal\\'s algorithm uses DSU."
    },
    {
      "question": "How to detect cycle using DSU?",
      "options": [
        "Union returns false",
        "Find returns null",
        "Union throws",
      ...
      "answer": 0,
      "explanation": "If union returns false, elements already connected -> cycle."
    }
  ]
};
