export const dsa_queues = {
  ...
  "laymanDefinition": "A queue is like a line at a coffee shop. People join at the back (enqueue). The person at the front gets served and leaves (dequeue). First come, first served — FIFO.",
  "deepDive": [
    {
      "heading": "FIFO Principle",
      "text": "First In, First Out. Add at rear, remove from front. Opposite of stack (LIFO)."
    },
    {
      "heading": "Circular Buffer",
      "text": "Fixed-size array with front/rear pointers. Wraps around using modulo. O(1) but fixed capacity."
    },
    {
      "heading": "Linked List Queue",
      "text": "Head = front, Tail = rear. O(1) enqueue/dequeue. No capacity limit. More memory overhead."
    },
    {
      "heading": "Applications",
      "text": "BFS, task scheduling, request queuing, message queues, I/O buffering, printer spooling."
    }
  ],
  "interviewAnswer": "Queues are fundamental for FIFO processing. Use circular buffer for bounded queues. Linked-list for unbounded. BFS requires a queue. Deque (double-ended queue) allows O(1) at both ends.",
  "interviewQuestions": [
    {
  ...
  "codeExamples": [
    {
      ...
      "description": "Linked list queue with front/rear O(1)."
    },
    {
      "title": "Circular Array Queue",
      "useCase": "Fixed capacity O(1).",
      ...
      "description": "O(1) with modulo wrapping."
    },
    {
      "title": "BFS Level Order",
      "useCase": "Queue-based tree traversal.",
      "code": "function levelOrder(root) {\n  if (!root) return [];\n  const q = [root], res = [];\n  while (q.length) {\n    const len = q.length, lvl = [];\n    for (let i = 0; i < len; i++) {\n      const n = q.shift(); lvl.push(n.val);\n      if (n.left) q.push(n.left);\n      if (n.right) q.push(n.right);\n    }\n    res.push(lvl);\n  }\n  return res;\n}",
      "description": "O(n) BFS using queue."
    },
    {
      "title": "Deque (Double-Ended Queue)",
      "useCase": "O(1) both ends.",
      ...
      "description": "Deque O(1) operations both ends."
    }
  ],
  "mcqQuestions": [
    {
    ...
    {
      "question": "Time of enqueue/dequeue?",
      "options": [
        "O(n)",
        "O(log n)",
        "O(1)",
    ...
    {
      "question": "Algorithm using queue?",
      "options": [
        "DFS",
        "BFS",
        "Binary search",
    ...
    {
      "question": "Why not array.shift() for queue?",
      "options": [
      ...
      "answer": 0,
      "explanation": "O(n) because all elements shift."
    },
    {
      "question": "Circular buffer used for?",
      "options": [
        "Resizing arrays",
        "O(1) fixed-capacity queue",
        "Tree traversal",
        "Sorting"
      ],
      "answer": 1,
      "explanation": "O(1) fixed-capacity queue."
    },
    {
